...
<svg xmlns="http://www.w3.org/2000/svg" class="scribble-circle" id="scribble-\${id}" data-turn="\${turn}" viewBox="0 0 522.23163 525.4444">
	<clipPath id="scribble-pool-clip-path">
		<path
  ...
  <path
		 clip-path="url(#scribble-pool-clip-path)"
		 fill="none" stroke-miterlimit="0" stroke-width="70"
		 class="scribble-path"
